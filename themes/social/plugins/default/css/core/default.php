...
.topbar .topbar-social-theme-notification {
    top: 50%;
    left: 50%;
...
.messages-with .widget-heading .user-icon-smaller {
	border-radius:50%;
}
/************************************************
...
/***********************************************
	V9.0 
************************************************/
.ossn-layout-startup .glass-signup-card {
	background: #fff;
...
.ossn-layout-startup .glass-signup-card::after {
	content: "";
	position: absolute;
	top: 0;
	left: 0;
...
.ossn-login .login-icon-badge {
	...
	background: #60696f;
	font-size: 24px;
	box-shadow: 0 8px 20px rgb(96 105 111 / 23%);
