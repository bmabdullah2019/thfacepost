...
$en = array(
		...
		'theme:white:homepage:image'       => 'Landing page image (Lite)',
		'theme:white:homepage:image:dark'  => 'Landing page image (Dark)',
		...
		'theme:white:latestmember:widget'  => 'Latest Members widget',
		'theme:white:thememode'            => 'Theme Mode (You can change later)',
		'theme:white:default:mode:field'   => 'Allow mode selection on signup page?',
		'theme:white:yes'                  => 'Yes',
		'theme:white:no'                   => 'No',
		'theme:white:lbgs:reset' 		   => 'Reset',
);
