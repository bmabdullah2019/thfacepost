...
Premium Social Network must be installed on a live, registered domain. The license is domain-specific and can only be changed upon request. Installation on localhost, IP addresses, or local servers is not supported and will not work. Please ensure you install the software on your actual domain.
</div>
<?php 
...
if(extension_loaded('ionCube Loader')){
    ...
    if(!version_compare($ioncube_version, '15.0', '>=')) {
		echo '<div class="ossn-installation-message ossn-installation-fail">PHP Extension ionCube Loader Minimum 15 required,  found: '.$ioncube_version.'</div>'; 
		$error[] = 'php';	
	}
} else {
