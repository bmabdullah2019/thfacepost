...
if(isset($params['businesspage']) && !$params['businesspage'] || !isset($params['businesspage'])){
	$user = ossn_user_by_guid($comment->owner_guid);
} 
...
<div class="comments-item" id="comments-item-<?php echo $comment->id; ?>">
	<div class="d-flex flex-row">
		<div class="pe-1">
        	<?php if(isset($params['businesspage']) && !$params['businesspage'] || !isset($params['businesspage'])){ ?>
					...
					if(isset($params['businesspage']) && !$params['businesspage'] || !isset($params['businesspage'])){
							echo ossn_plugin_view('output/user/url', array(
			 				...
			 				echo ossn_plugin_view('output/url', array(
									'href' => $params['businesspage']->getURL(), 
